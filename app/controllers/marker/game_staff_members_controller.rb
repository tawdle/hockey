  ...
  def create
    ...
    respond_to do |format|
      if game_staff_member.save
        format.html { redirect_to marker_game_path(@game), notice: t("controllers.marker.game_staff_members.create.success") }
  ...
  def update
    respond_to do |format|
      if @game.update_attributes(fix_params[:game])
        format.html { redirect_to marker_game_path(@game), notice: t("controllers.marker.game_staff_members.update.success") }
