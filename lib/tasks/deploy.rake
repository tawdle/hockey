...
namespace :deploy do
  PRODUCTION_APP = 'powerplay-production'
  STAGING_APP = 'powerplay-staging'

  task :staging => [:set_staging_app, :push, :restart, :tag]
  task :production => [:set_production_app, :push, :restart, :tag]

  task :staging_with_migrations => [:set_staging_app, :push, :off, :migrate, :restart, :on, :tag]
  task :staging_rollback => [:set_staging_app, :off, :push_previous, :restart, :on]

  task :production_with_migrations => [:set_production_app, :push, :off, :migrate, :restart, :on, :tag]
